...
def mysqlconnect():
    # Connect to MySQL
    cnx = pymysql.connect(host="jvsa.cby.ap-northeast-1.rds.amazonaws.com", port=3306, user="xxxn", passwd="zxxx", db="xxx")
    cursor = cnx.cursor()
...
def Redshiftconnect():
    ...
    conn = redshift_connector.connect(
         host='xxxxift.210199513596.ap-northeast-1.redshift-serverless.amazonaws.com',
         database='dev',
         port=5439,
         user='admin',
         password='xxxxx'
...
#  jvdsa.ckht8fbw26hy.ap-northeast-1.rds.amazonaws.com
#  jvdft.210199513596.ap-northeast-1.redshift-serverless.amazonaws.com
#  172.30.2.84

##  jdbc:mysql://jvdckrdsa.ckht8fbw26hy.ap-northeast-1.rds.amazonaws.com:3306/fatpg
